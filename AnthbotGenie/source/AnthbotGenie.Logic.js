...
// (в нём нет %24/%2F, портить нечего); 1 — против AWS заведомо даёт 403, оставлен на случай
// клиента, который декодирует путь перед отправкой. Текущий вариант из перебора исключается.
//
...
const ANTHBOT_LOGIC_TOPIC_MODE_ORDER = [0, 2, 1];
...
const ANTHBOT_NAME_LABELS = {
    ...
    time: "Время сессии", area: "Площадь сессии"
};
